---
path: '/example/comment-list'
title: Comment list
desc: One of the biggest benefits of hosting a blog on an online store is that the audience can interact with merchants by commenting on blog posts. This code component will display the comments for a specific blog post.
category: blog
